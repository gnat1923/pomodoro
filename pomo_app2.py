...
class MyCustomSettingsFrame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.focus_time = tk.StringVar()
        self.focus_time.set(25)
        self.break_time = tk.StringVar()
        self.break_time.set(5)
        self.cycle_counter = tk.StringVar()
        self.cycle_counter.set(4)
        ...
        self.focus_time = customtkinter.CTkEntry(self, placeholder_text="Focus Duration - 25", textvariable=self.focus_time)
        self.focus_time.grid(row=1, column=0, padx=20, pady=(20,0), sticky="ew")
        self.break_time = customtkinter.CTkEntry(self, placeholder_text="Break Duration - 5", textvariable=self.break_time)
        self.break_time.grid(row=2, column=0, padx=20, pady=(20,0), sticky="ew")
        self.cycle_counter = customtkinter.CTkEntry(self, placeholder_text="No. of cycles - 4", textvariable=self.cycle_counter)
    ...
    def submit_config(self):
        # Some code here
        print(f"Custom settings copied \nFocus time: {self.focus_time.get()}\nBreak time: {self.break_time.get()}\nCycles: {self.cycle_counter.get()}")
...
class MyOperationFrame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.operations_label.grid(row=0, column=1, padx=20, pady=(20,0), sticky="ew")

        self.timer_label = customtkinter.CTkLabel(self, text="TIMER", corner_radius=6)
        self.timer_label.grid(row=1, column=1, padx=20, pady=(20,0), sticky="ew")

        self.message_label = customtkinter.CTkLabel(self, text="MESSAGE", corner_radius=6)
        self.message_label.grid(row=2, column=1, padx=20, pady=(20,20), sticky="ew")

        self.progressbar = customtkinter.CTkProgressBar(self, orientation="horizontal")
        self.progressbar.grid(row=3, column=1, padx=20, pady=(20,0), sticky="ew")
        ...
        self.button_start.grid(row=6, column=1, pady=20, padx=20, sticky="ew")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.operation_frame.grid(row=0, column=1, columnspan=3, padx=20, pady=20, sticky="nsw")

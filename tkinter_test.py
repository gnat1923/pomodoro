...
class MyScrollableCheckboxFrame(customtkinter.CTkScrollableFrame):
    ...
    def get(self):
        ...
        ''' Block made irrelevant by the for loops added to Class
...
class MyRadioButtonFrame(customtkinter.CTkFrame):
    def __init__(self, master, title, values):
        ...
        self.title = title
        self.radiobuttons = []
        self.variable = customtkinter.StringVar(value="") # You should try and get a better understanding of this
...
class App(customtkinter.CTk):
    ...
    def button_callback(self):
        print("Checkbox frame 1:", self.checkbox_frame_1.get())
        print("Radiobutton frame:", self.radiobutton_frame.get())
